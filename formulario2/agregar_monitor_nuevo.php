...
<head>
    <meta charset="UTF-8">
    <title>Agregar Nuevo Monitor</title>
...
<body>
    ...
    <form method="post" action="agregar_monitor_nuevo.php">
        <label for="nombre">NOMBRE DEL MONITOR NUEVO:</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $nombreMonitor = $_POST['nombre'];

    // Insertar el nuevo cliente en la base de datos
    $insertQuery = "INSERT INTO monitoresysupervisores (monitor) VALUES ('$nombreMonitor')";
