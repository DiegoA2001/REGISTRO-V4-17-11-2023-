...
<head>
    <meta charset="UTF-8">
    <title>Agregar Nuevo Supervisor</title>
...
<body>
    ...
    <form method="post" action="agregar_cliente_nuevo.php">
        <label for="nombre">NOMBRE DEL SUPERVISOR NUEVO:</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $nombreSupervisor = $_POST['nombre'];

    // Insertar el nuevo cliente en la base de datos
    $insertQuery = "INSERT INTO monitoresysupervisores (supervisor) VALUES ('$nombreSupervisor')";
